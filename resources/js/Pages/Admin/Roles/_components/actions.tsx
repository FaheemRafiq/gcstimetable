...
export function Actions({ row }: { row: Role }) {
  ...
  function handleEdit(row: Role) {
    router.get(route('roles.edit', row.id))
  }
  ...
  return (
    <Fragment>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-[160px]">
          ...
          <DropdownMenuGroup>
            ...
            <DropdownMenuItem className="cursor-pointer" onClick={() => handleEdit(row)}>
      ...
      <DeleteConfirmationDialog
        ...
        message={
          <p>
            Are you sure you want to delete this <strong>{row.name}</strong> role? This action
            cannot be undone.
          </p>
        }
        processing={deleting}
