      ...
      <div className="bg-card text-card-foreground border border-border sm:rounded-lg">
        <div className="p-6 flex flex-col">
          <div className="flex justify-between">
            ...
            <Link href={route('semesters.index')} className="flex items-center space-x-2">
          ...
          <div className="space-y-4 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-background text-foreground p-6 sm:rounded-lg shadow-lg">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2">Is Active</h3>
                <span>
              ...
              <div>
                ...
                <span>
                  <Badge variant={'secondary'}>{semester?.sections?.length}</Badge>
                </span>
              </div>
            </div>
            ...
            <div className="bg-background text-foreground p-6 sm:rounded-lg shadow-lg">
              <div className="mb-4">
                <IndexPage sections={sections ?? []} semesterId={semester.id} />
              </div>
            </div>
          </div>
        </div>
