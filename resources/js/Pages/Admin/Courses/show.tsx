      ...
      <div className="bg-card text-card-foreground border border-border sm:rounded-lg">
        <div className="p-6 flex flex-col">
          <div className="flex justify-between">
            ...
            <Link href={route('courses.index')} className="flex items-center space-x-2">
          ...
          <div className="space-y-4 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-background text-foreground p-6 sm:rounded-lg shadow-lg">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2">Display Code</h3>
                <p>{course.display_code}</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold mb-2">No. Semester</h3>
              ...
              <div>
                ...
                <span>
                  <Badge
                    variant={course.is_default === 1 ? 'success' : 'destructive'}
                    className="capitalize"
                  >
                    {course.is_default === 1 ? 'Default' : 'Not Default'}
                  </Badge>
                </span>
              </div>
            </div>
