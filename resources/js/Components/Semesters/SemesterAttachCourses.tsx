        ...
        fetchWrapper({
            ...
            .then((response) => {
                ...
                if (response.semester && response.semester.courses) {
                    setData("courses", response.semester.courses.map((course: Course) => {
        ...
        <Dialog defaultOpen={open} onOpenChange={() => handleOpen(false)}>
            <DialogContent className="md:min-w-[70%] lg:min-w-[60%] bg-background">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Select the courses and attach to the semester.
                    </DialogDescription>
                </DialogHeader>
                <form id="SemesterAttachForm" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-2">
                        ...
                        <MultipleSelector
                            ...
                            onChange={(value) => setData("courses", value.map(v => ({ ...v, value: Number(v.value) })))}
